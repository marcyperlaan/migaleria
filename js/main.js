...
var textos= ["TATTOO ART:<br>This section is a gateway for transforming skin into living canvases of art.<br> Each piece is a testament to his dedication to pushing the boundaries of this unique form of self-expression.",
      "FINE ART:<br>Explore Marc' s Fine Art collection, a curated blend of traditional works of art that pay homage to the heritage of artistic craftsmanship. <br> Discover his passion for anatomy, merging classical techniques with a modern perspective.",
      "DIGITAL ART:<br>Within this space, you can explore innovative digital creations that blend classical perspectives with a fusion of technology and imagination. <br>These works transport you to otherworldly landscapes and delve into thought-provoking concepts.<br>Dive into the pixels and uncover boundless possibilities."];
...
function getColorForRectangulo(seccion) {
    ...
    return 'black'; // Color predeterminado si no coincide con ningún rectángulo
}
